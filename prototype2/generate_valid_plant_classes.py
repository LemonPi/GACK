...
def calctraffic(plant):
	thing = plant["char"]["Foot Traffic"][-1]
	traffics = ["None", "Light", "Moderate", "High"]
	for i in range(4):
		if traffics[i] == thing:
			return i
	return 2
...
def cleanup(plant):
	outplant = {
		...
		"spread": calcspread(plant),
		"traffic": calctraffic(plant),
	}
	return outplant
